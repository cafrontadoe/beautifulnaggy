...
describe('Service Tests', () => {
    describe('TypeDoc Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new TypeDoc(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a TypeDoc', async () => {
            ...
            it('should update a TypeDoc', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB'
                    },
            ...
            it('should return a list of TypeDoc', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB'
                    },
            ...
            it('should delete a TypeDoc', async () => {
