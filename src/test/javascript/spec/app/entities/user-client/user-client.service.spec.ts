...
import { IUserClient, UserClient } from 'app/shared/model/user-client.model';
...
describe('Service Tests', () => {
    describe('UserClient Service', () => {
        ...
        let elemDefault: IUserClient;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(UserClientService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new UserClient(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
